...
namespace metrics.Tests
{
    ...
    public class TimeUnitTests
    {
        ...
        public void Can_convert_days_to_nanoseconds()
        {
            ...
            long actual = TimeUnit.Days.ToNanos(duration);
        ...
        public void Can_convert_milliseconds_to_microseconds()
        {
            ...
            long actual = TimeUnit.Milliseconds.ToMicros(expected);
            Trace.WriteLine(actual);
        ...
        {
            const long expected = 1000;
            long actual = TimeUnit.Milliseconds.ToMillis(expected);
            Trace.WriteLine(actual);
        ...
        public void Can_convert_milliseconds_to_minutes()
        {
            ...
            long actual = TimeUnit.Milliseconds.ToMinutes(expected);
            Trace.WriteLine(actual);
        ...
        {
            const long expected = 1000;
            long actual = TimeUnit.Milliseconds.ToNanos(expected);
            Trace.WriteLine(actual);
        ...
        {
            const long expected = 10000000;
            long actual = TimeUnit.Milliseconds.ToSeconds(expected);
            Trace.WriteLine(actual);
        ...
        public void Can_convert_minutes_to_milliseconds()
        {
            ...
            long actual = TimeUnit.Minutes.ToMillis(duration);
            Trace.WriteLine(actual);
        ...
        public void Can_convert_nanoseconds_to_days()
        {
            ...
            long actual = TimeUnit.Nanoseconds.ToDays(duration);
        ...
        {
            const long expected = 1000;
            long actual = TimeUnit.Nanoseconds.ToMicros(expected);
            Trace.WriteLine(actual);
        ...
        {
            const long expected = 10000000;
            long actual = TimeUnit.Nanoseconds.ToMillis(expected);
            Trace.WriteLine(actual);
        ...
        {
            const long expected = 1000;
            long actual = TimeUnit.Nanoseconds.ToNanos(expected);
            Trace.WriteLine(actual);
            Assert.AreEqual(1000L, actual);
        }
        ...
        public void Can_convert_nanoseconds_to_seconds()
        {
            ...
            long actual = TimeUnit.Nanoseconds.ToSeconds(expected);
            Trace.WriteLine(actual);
            Assert.AreEqual(10, actual);
        }
    }
